  ...
  return (
    <div className="hide-scrollbar">
      <div className="w-full relative">
        ...
        {/* Scrollable Content */}
        <section className="w-full bg-black font-bold text-white p-10">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl font-semibold mb-4">About the Platform</h2>
            <p className="mb-6">
              This platform streamlines the hiring process using AI-powered
              tools such as Resume Scanning, Interview Scheduling, and
