        ...
        >
          ...
          >
            ...
            <img
              ...
              src="https://github.com/ayantikdas2004/ayantik.com/blob/main/img2.png?raw=true"
              alt="user"
            />
          </button>
        ...
        >
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li className="relative" ref={serviceDropdownRef}>
              ...
              <ul
                className={`absolute left-0 z-10 w-44 mt-2 bg-white rounded-lg shadow-lg dark:bg-gray-700 transition-all duration-300 ${
