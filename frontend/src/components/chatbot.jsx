...
import chatbotIcon from "../assets/chatbot.png"; // Ensure correct path
...
const ChatbotButton = () => {
  ...
  return (
    <>
      ...
      {/* Chatbot Panel */}
      <div
        className={`fixed bottom-20 right-6 w-80 h-96 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg shadow-xl z-50 flex flex-col overflow-hidden transition-transform duration-300 ${
          isOpen
      ...
      >
        ...
        <div className="flex-1 p-4 overflow-y-auto text-sm text-gray-800 dark:text-gray-100">
          ...
          {/* Additional chat content or chat component can be inserted here */}
        </div>
